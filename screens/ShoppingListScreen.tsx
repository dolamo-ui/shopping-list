            ...
            <View style={styles.modalBG}>
              <View style={styles.modalBox}>
                ...
                <View style={{ flexDirection: "row", marginTop: 10 }}>
                  <TouchableOpacity style={styles.saveBtn} onPress={saveCreate}>
...
function ItemCard({ item }: { item: Item }) {
  ...
  const saveEdit = () => {
    ...
    dispatch(editItem({ ...item, name: editName, quantity: Number(editQty) || 1, price: Number(editPrice) || 0 }));
    setEditMode(false);
  };
  ...
  return (
    <View style={[styles.item, item.purchased && styles.itemDone]}>
      <View style={styles.itemHeader}>
        ...
        <TouchableOpacity onPress={() => setEditMode(true)} style={{ flex: 1, marginHorizontal: 8 }}>
          <Text style={[styles.itemText, item.purchased && { textDecorationLine: "line-through", opacity: 0.5 }]}>
      ...
      {editMode && (
        <View style={styles.editBox}>
          <TextInput style={styles.editInput} value={editName} onChangeText={setEditName} placeholder="Item Name" />
          <TextInput style={styles.editInput} keyboardType="numeric" value={editQty} onChangeText={setEditQty} placeholder="Quantity" />
          <TextInput style={styles.editInput} keyboardType="numeric" value={editPrice} onChangeText={setEditPrice} placeholder="Price" />
          <View style={{ flexDirection: "row", marginTop: 10 }}>
            <TouchableOpacity style={styles.saveBtn} onPress={saveEdit}><Text style={{ color: "white" }}>Save</Text></TouchableOpacity>
            <TouchableOpacity style={styles.cancelBtn} onPress={() => setEditMode(false)}><Text style={{ color: "white" }}>Cancel</Text></TouchableOpacity>
          </View>
        </View>
      )}
    </View>
